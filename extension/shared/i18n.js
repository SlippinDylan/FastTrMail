(function initI18n(scope) {
  ...
  const MESSAGE_CATALOG = Object.freeze({
    "zh-CN": Object.freeze({
      ...
      "options.heroIntro": "给网页邮箱正文加一个内嵌翻译按钮。点击邮箱工具区里的“翻译”后，译文会追加在原文下方，不覆盖原文。",
      ...
      "provider.google-web": "Google Web（免 Key）",
    ...
    en: Object.freeze({
      ...
      "popup.documentTitle": "FastTrMail",
      "popup.subtitle": "Webmail message translation helper",
      ...
      "options.heroIntro": "Adds an inline translate button to webmail message bodies. After you click Translate in the message toolbar, the translated text is appended below the original without replacing it.",
      ...
      "provider.google-web": "Google Web (No Key)",
      "provider.google-api": "Google Cloud API",
      "provider.microsoft": "Microsoft Translator API",
    ...
    "zh-TW": Object.freeze({
      ...
      "options.heroIntro": "為網頁郵件正文加入一個內嵌翻譯按鈕。點擊郵件工具區裡的「翻譯」後，譯文會追加在原文下方，不覆蓋原文。",
    ...
    "zh-HK": Object.freeze({
      ...
      "popup.loadFailed": "讀取失敗",
      "options.documentTitle": "FastTrMail 設定",
      "options.heroIntro": "為網頁郵件正文加入一個內嵌翻譯按鈕。點擊郵件工具區內的「翻譯」後，譯文會附加在原文下方，不會覆蓋原文。",
      "options.generalSettingsTitle": "一般設定",
      "options.generalSettingsDescription": "這裡決定擴充功能預設使用哪個翻譯服務，以及翻譯成哪種目標語言。",
      "options.uiLanguage": "介面語言",
      "options.translationProvider": "翻譯服務 Provider",
